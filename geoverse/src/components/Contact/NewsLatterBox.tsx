...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      Subscribe now to stay updated with the latest geophysical tools, articles, and insights from Geoverse!
      </p>
      <div>
        <input
          type="text"
        ...
        No Spam guaranteed! We respect your inbox, so please don’t send any spam emails.
        </p>
      </div>
