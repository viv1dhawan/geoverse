...
earthquakes = sqlalchemy.Table(
    ...
    sqlalchemy.Column("mag", sqlalchemy.Float),
    sqlalchemy.Column("magType", sqlalchemy.String(50)),
    sqlalchemy.Column("nst", sqlalchemy.Integer),
    sqlalchemy.Column("gap", sqlalchemy.Float),
    sqlalchemy.Column("dmin", sqlalchemy.Float),
    sqlalchemy.Column("rms", sqlalchemy.Float),
    sqlalchemy.Column("net", sqlalchemy.String(50)),
    ...
    sqlalchemy.Column("horizontalError", sqlalchemy.Float),
    sqlalchemy.Column("depthError", sqlalchemy.Float),
    sqlalchemy.Column("magError", sqlalchemy.Float),
    sqlalchemy.Column("magNst", sqlalchemy.Integer),
